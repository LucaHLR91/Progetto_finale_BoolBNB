                            ...
                            <div class="row product-gallery mx-1">
                                ...
                                <div class="col-12 mb-0">
                                    <figure class="view overlay rounded z-depth-1 main-img">
                                        <img src="{{ asset('storage/image_apartments/' . $result->image) }}"
                                            alt="" title="" style="width:200px; height:200px">
                            ...
                            <form action="{{ route('admin.messages.store') }}" method="post">
                                ...
                                <div class="form-group message-form">
                                    ...
                                    <input required type="email" name="email"
                                        ...
                                        id="exampleInputEmail1" aria-describedby="emailHelp" <blade
                                        if|%20(Auth%3A%3Auser()%20%3D%3D%20null)>
                                ...
                                <div class="form-group message-form">
                                    ...
                                    <textarea required class="form-control @error('message') is-invalid @enderror"
                                        name="text" id="exampleFormControlTextarea1" rows="3"
                                ...
                                <button <blade if|%20(Auth%3A%3Auser()%20%3D%3D%20null)>
